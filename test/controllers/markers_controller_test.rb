...
class MarkersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create marker" do
    assert_difference('Marker.count') do
      post markers_url, params: { marker: { category_id: @marker.category_id, tipo: @marker.tipo, title: @marker.title } }
    end
  ...
  test "should update marker" do
    patch marker_url(@marker), params: { marker: { category_id: @marker.category_id, tipo: @marker.tipo, title: @marker.title } }
